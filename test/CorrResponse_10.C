...
JetResponseEt10Eta6->Fit("gaus","","",0.5,1.5);
c1.Print("tmp/1sigma/JetResponseEt10Eta6.gif");
fit[0] = JetResponseEt10Eta6->GetFunction("gaus");
 
JetResponseEt12Eta6->Fit("gaus","","",0.6,1.4);
c1.Print("tmp/1sigma/JetResponseEt12Eta6.gif");
fit[1] = JetResponseEt12Eta6->GetFunction("gaus");
 
JetResponseEt15Eta6->Fit("gaus","","",0.7,1.3);
c1.Print("tmp/1sigma/JetResponseEt15Eta6.gif");
fit[2] = JetResponseEt15Eta6->GetFunction("gaus");
 
JetResponseEt20Eta6->Fit("gaus","","",0.8,1.2);
c1.Print("tmp/1sigma/JetResponseEt20Eta6.gif");
fit[3] = JetResponseEt20Eta6->GetFunction("gaus");
 
JetResponseEt27Eta6->Fit("gaus","","",0.8,1.2);
c1.Print("tmp/1sigma/JetResponseEt27Eta6.gif");
fit[4] = JetResponseEt27Eta6->GetFunction("gaus");
 
JetResponseEt35Eta6->Fit("gaus","","",0.8,1.2);
c1.Print("tmp/1sigma/JetResponseEt35Eta6.gif");
fit[5] = JetResponseEt35Eta6->GetFunction("gaus");
                                                                                
JetResponseEt45Eta6->Fit("gaus","","",0.81,1.19);
c1.Print("tmp/1sigma/JetResponseEt45Eta6.gif");
fit[6] = JetResponseEt45Eta6->GetFunction("gaus");
 
JetResponseEt57Eta6->Fit("gaus","","",0.82,1.18);
c1.Print("tmp/1sigma/JetResponseEt57Eta6.gif");
fit[7] = JetResponseEt57Eta6->GetFunction("gaus");

JetResponseEt72Eta6->Fit("gaus","","",0.84,1.16);
c1.Print("tmp/1sigma/JetResponseEt72Eta6.gif");
fit[8] = JetResponseEt72Eta6->GetFunction("gaus");

JetResponseEt90Eta6->Fit("gaus","","",0.85,1.15);
c1.Print("tmp/1sigma/JetResponseEt90Eta6.gif");
fit[9] = JetResponseEt90Eta6->GetFunction("gaus");

JetResponseEt120Eta6->Fit("gaus","","",0.87,1.13);
c1.Print("tmp/1sigma/JetResponseEt120Eta6.gif");
fit[10] = JetResponseEt120Eta6->GetFunction("gaus");

JetResponseEt150Eta6->Fit("gaus","","",0.88,1.12);
c1.Print("tmp/1sigma/JetResponseEt150Eta6.gif");
fit[11] = JetResponseEt150Eta6->GetFunction("gaus");

JetResponseEt200Eta6->Fit("gaus","","",0.88,1.12);
c1.Print("tmp/1sigma/JetResponseEt200Eta6.gif");
fit[12] = JetResponseEt200Eta6->GetFunction("gaus");

JetResponseEt300Eta6->Fit("gaus","","",0.90,1.10);
c1.Print("tmp/1sigma/JetResponseEt300Eta6.gif");
fit[13] = JetResponseEt300Eta6->GetFunction("gaus");

JetResponseEt400Eta6->Fit("gaus","","",0.92,1.08);
c1.Print("tmp/1sigma/JetResponseEt400Eta6.gif");
fit[14] = JetResponseEt400Eta6->GetFunction("gaus");

JetResponseEt550Eta6->Fit("gaus","","",0.93,1.07);
c1.Print("tmp/1sigma/JetResponseEt550Eta6.gif");
fit[15] = JetResponseEt550Eta6->GetFunction("gaus");

JetResponseEt750Eta6->Fit("gaus","","",0.92,1.08);
c1.Print("tmp/1sigma/JetResponseEt750Eta6.gif");
fit[16] = JetResponseEt750Eta6->GetFunction("gaus");

JetResponseEt1000Eta6->Fit("gaus","","",0.95,1.05);
c1.Print("tmp/1sigma/JetResponseEt1000Eta6.gif");
fit[17] = JetResponseEt1000Eta6->GetFunction("gaus");

JetResponseEt1400Eta6->Fit("gaus","","",0.94,1.04);
c1.Print("tmp/1sigma/JetResponseEt1400Eta6.gif");
fit[18] = JetResponseEt1400Eta6->GetFunction("gaus");

JetResponseEt2000Eta6->Fit("gaus","","",0.94,1.04);
c1.Print("tmp/1sigma/JetResponseEt2000Eta6.gif");
fit[19] = JetResponseEt2000Eta6->GetFunction("gaus");

JetResponseEt2900Eta6->Fit("gaus","","",0.94,1.04);
c1.Print("tmp/1sigma/JetResponseEt2900Eta6.gif");
...
ofstream outFile("CorrResponse_10_1sigma.dat");
...
l = new TLine(10,1.0,1000,1.0);
l->SetLineStyle(2);
l->Draw();
  
c2hA.Print("CorrResponse_10_1sigma.eps");
c2hA.Print("CorrResponse_10_1sigma.gif");
