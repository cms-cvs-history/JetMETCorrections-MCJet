...
ofstream outFile("CorrResponse_05_1sigma.dat");
for (Int_t i=0; i<n; i++){
...
c2hA.Print("CorrResponse_05_1sigma.eps");
c2hA.Print("CorrResponse_05_1sigma.gif");
