...
JetResponseEt10Eta14->Fit("gaus","","",0.5,1.5);
c1.Print("tmp/1sigma/JetResponseEt10Eta14.gif");
fit[0] = JetResponseEt10Eta14->GetFunction("gaus");
 
JetResponseEt12Eta14->Fit("gaus","","",0.6,1.4);
c1.Print("tmp/1sigma/JetResponseEt12Eta14.gif");
fit[1] = JetResponseEt12Eta14->GetFunction("gaus");
 
JetResponseEt15Eta14->Fit("gaus","","",0.7,1.3);
c1.Print("tmp/1sigma/JetResponseEt15Eta14.gif");
fit[2] = JetResponseEt15Eta14->GetFunction("gaus");
 
JetResponseEt20Eta14->Fit("gaus","","",0.8,1.2);
c1.Print("tmp/1sigma/JetResponseEt20Eta14.gif");
fit[3] = JetResponseEt20Eta14->GetFunction("gaus");
 
JetResponseEt27Eta14->Fit("gaus","","",0.8,1.2);
c1.Print("tmp/1sigma/JetResponseEt27Eta14.gif");
fit[4] = JetResponseEt27Eta14->GetFunction("gaus");
 
JetResponseEt35Eta14->Fit("gaus","","",0.8,1.2);
c1.Print("tmp/1sigma/JetResponseEt35Eta14.gif");
fit[5] = JetResponseEt35Eta14->GetFunction("gaus");
                                                                                
JetResponseEt45Eta14->Fit("gaus","","",0.81,1.19);
c1.Print("tmp/1sigma/JetResponseEt45Eta14.gif");
fit[6] = JetResponseEt45Eta14->GetFunction("gaus");
 
JetResponseEt57Eta14->Fit("gaus","","",0.82,1.18);
c1.Print("tmp/1sigma/JetResponseEt57Eta14.gif");
fit[7] = JetResponseEt57Eta14->GetFunction("gaus");

JetResponseEt72Eta14->Fit("gaus","","",0.84,1.16);
c1.Print("tmp/1sigma/JetResponseEt72Eta14.gif");
fit[8] = JetResponseEt72Eta14->GetFunction("gaus");

JetResponseEt90Eta14->Fit("gaus","","",0.85,1.15);
c1.Print("tmp/1sigma/JetResponseEt90Eta14.gif");
fit[9] = JetResponseEt90Eta14->GetFunction("gaus");

JetResponseEt120Eta14->Fit("gaus","","",0.87,1.13);
c1.Print("tmp/1sigma/JetResponseEt120Eta14.gif");
fit[10] = JetResponseEt120Eta14->GetFunction("gaus");

JetResponseEt150Eta14->Fit("gaus","","",0.88,1.12);
c1.Print("tmp/1sigma/JetResponseEt150Eta14.gif");
fit[11] = JetResponseEt150Eta14->GetFunction("gaus");

JetResponseEt200Eta14->Fit("gaus","","",0.88,1.12);
c1.Print("tmp/1sigma/JetResponseEt200Eta14.gif");
fit[12] = JetResponseEt200Eta14->GetFunction("gaus");

JetResponseEt300Eta14->Fit("gaus","","",0.90,1.10);
c1.Print("tmp/1sigma/JetResponseEt300Eta14.gif");
fit[13] = JetResponseEt300Eta14->GetFunction("gaus");

JetResponseEt400Eta14->Fit("gaus","","",0.92,1.08);
c1.Print("tmp/1sigma/JetResponseEt400Eta14.gif");
fit[14] = JetResponseEt400Eta14->GetFunction("gaus");

JetResponseEt550Eta14->Fit("gaus","","",0.93,1.07);
c1.Print("tmp/1sigma/JetResponseEt550Eta14.gif");
fit[15] = JetResponseEt550Eta14->GetFunction("gaus");

JetResponseEt750Eta14->Fit("gaus","","",0.94,1.06);
c1.Print("tmp/1sigma/JetResponseEt750Eta14.gif");
fit[16] = JetResponseEt750Eta14->GetFunction("gaus");

JetResponseEt1000Eta14->Fit("gaus","","",0.94,1.06);
c1.Print("tmp/1sigma/JetResponseEt1000Eta14.gif");
fit[17] = JetResponseEt1000Eta14->GetFunction("gaus");

JetResponseEt1400Eta14->Fit("gaus","","",0.94,1.06);
c1.Print("tmp/1sigma/JetResponseEt1400Eta14.gif");
fit[18] = JetResponseEt1400Eta14->GetFunction("gaus");

JetResponseEt2000Eta14->Fit("gaus","","",0.94,1.06);
c1.Print("tmp/1sigma/JetResponseEt2000Eta14.gif");
fit[19] = JetResponseEt2000Eta14->GetFunction("gaus");

JetResponseEt2900Eta14->Fit("gaus","","",0.94,1.06);
c1.Print("tmp/1sigma/JetResponseEt2900Eta14.gif");
...
ofstream outFile("CorrResponse_02_1sigma.dat");
for (Int_t i=0; i<n; i++){
...
c2hA.Print("CorrResponse_02_1sigma.eps");
c2hA.Print("CorrResponse_02_1sigma.gif");
