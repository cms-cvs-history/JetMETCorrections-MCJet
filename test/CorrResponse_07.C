...
TH1F *histResp[n];
histResp[0] = (TH1F)JetResponseEt10Eta9->Clone();
histResp[1] = (TH1F)JetResponseEt12Eta9->Clone();
histResp[2] = (TH1F)JetResponseEt15Eta9->Clone();
histResp[3] = (TH1F)JetResponseEt20Eta9->Clone();
histResp[4] = (TH1F)JetResponseEt27Eta9->Clone();
histResp[5] = (TH1F)JetResponseEt35Eta9->Clone();
histResp[6] = (TH1F)JetResponseEt45Eta9->Clone();
histResp[7] = (TH1F)JetResponseEt57Eta9->Clone();
histResp[8] = (TH1F)JetResponseEt72Eta9->Clone();
histResp[9] = (TH1F)JetResponseEt90Eta9->Clone();
histResp[10] = (TH1F)JetResponseEt120Eta9->Clone();
histResp[11] = (TH1F)JetResponseEt150Eta9->Clone();
histResp[12] = (TH1F)JetResponseEt200Eta9->Clone();
histResp[13] = (TH1F)JetResponseEt300Eta9->Clone();
histResp[14] = (TH1F)JetResponseEt400Eta9->Clone();
histResp[15] = (TH1F)JetResponseEt550Eta9->Clone();
histResp[16] = (TH1F)JetResponseEt750Eta9->Clone();
histResp[17] = (TH1F)JetResponseEt1000Eta9->Clone();
histResp[18] = (TH1F)JetResponseEt1400Eta9->Clone();
histResp[19] = (TH1F)JetResponseEt2000Eta9->Clone();
histResp[20] = (TH1F)JetResponseEt2900Eta9->Clone();
histResp[21] = (TH1F)JetResponseEt4500Eta9->Clone();

TH1F *histEt[n];
histEt[0] = (TH1F)EtGenJetEt10Eta9->Clone();
histEt[1] = (TH1F)EtGenJetEt12Eta9->Clone();
histEt[2] = (TH1F)EtGenJetEt15Eta9->Clone();
histEt[3] = (TH1F)EtGenJetEt20Eta9->Clone();
histEt[4] = (TH1F)EtGenJetEt27Eta9->Clone();
histEt[5] = (TH1F)EtGenJetEt35Eta9->Clone();
histEt[6] = (TH1F)EtGenJetEt45Eta9->Clone();
histEt[7] = (TH1F)EtGenJetEt57Eta9->Clone();
histEt[8] = (TH1F)EtGenJetEt72Eta9->Clone();
histEt[9] = (TH1F)EtGenJetEt90Eta9->Clone();
histEt[10] = (TH1F)EtGenJetEt120Eta9->Clone();
histEt[11] = (TH1F)EtGenJetEt150Eta9->Clone();
histEt[12] = (TH1F)EtGenJetEt200Eta9->Clone();
histEt[13] = (TH1F)EtGenJetEt300Eta9->Clone();
histEt[14] = (TH1F)EtGenJetEt400Eta9->Clone();
histEt[15] = (TH1F)EtGenJetEt550Eta9->Clone();
histEt[16] = (TH1F)EtGenJetEt750Eta9->Clone();
histEt[17] = (TH1F)EtGenJetEt1000Eta9->Clone();
histEt[18] = (TH1F)EtGenJetEt1400Eta9->Clone();
histEt[19] = (TH1F)EtGenJetEt2000Eta9->Clone();
histEt[20] = (TH1F)EtGenJetEt2900Eta9->Clone();
histEt[21] = (TH1F)EtGenJetEt4500Eta9->Clone();

char *name[n];
name[0] = "JetResponseEt10Eta9";
name[1] = "JetResponseEt12Eta9";
name[2] = "JetResponseEt15Eta9";
name[3] = "JetResponseEt20Eta9";
name[4] = "JetResponseEt27Eta9";
name[5] = "JetResponseEt35Eta9";
name[6] = "JetResponseEt45Eta9";
name[7] = "JetResponseEt57Eta9";
name[8] = "JetResponseEt72Eta9";
name[9] = "JetResponseEt90Eta9";
name[10] = "JetResponseEt120Eta9";
name[11] = "JetResponseEt150Eta9";
name[12] = "JetResponseEt200Eta9";
name[13] = "JetResponseEt300Eta9";
name[14] = "JetResponseEt400Eta9";
name[15] = "JetResponseEt550Eta9";
name[16] = "JetResponseEt750Eta9";
name[17] = "JetResponseEt1000Eta9";
name[18] = "JetResponseEt1400Eta9";
name[19] = "JetResponseEt2000Eta9";
name[20] = "JetResponseEt2900Eta9";
name[21] = "JetResponseEt4500Eta9";
...
ofstream outFile("CorrResponse_07.dat");
...
gr->SetTitle("MC Jets Calibration, Midpoint R=0.5, 1.496  < | #eta | < 1.757");
...
c1.Print("CorrResponse_07.eps");
c1.Print("CorrResponse_07.gif");
