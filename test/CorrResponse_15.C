...
TH1F *histResp[n];
histResp[0] = (TH1F)JetResponseEt10Eta1->Clone();
histResp[1] = (TH1F)JetResponseEt12Eta1->Clone();
histResp[2] = (TH1F)JetResponseEt15Eta1->Clone();
histResp[3] = (TH1F)JetResponseEt20Eta1->Clone();
histResp[4] = (TH1F)JetResponseEt27Eta1->Clone();
histResp[5] = (TH1F)JetResponseEt35Eta1->Clone();
histResp[6] = (TH1F)JetResponseEt45Eta1->Clone();
histResp[7] = (TH1F)JetResponseEt57Eta1->Clone();
histResp[8] = (TH1F)JetResponseEt72Eta1->Clone();
histResp[9] = (TH1F)JetResponseEt90Eta1->Clone();
histResp[10] = (TH1F)JetResponseEt120Eta1->Clone();
histResp[11] = (TH1F)JetResponseEt150Eta1->Clone();
histResp[12] = (TH1F)JetResponseEt200Eta1->Clone();
histResp[13] = (TH1F)JetResponseEt300Eta1->Clone();
histResp[14] = (TH1F)JetResponseEt400Eta1->Clone();
histResp[15] = (TH1F)JetResponseEt550Eta1->Clone();
histResp[16] = (TH1F)JetResponseEt750Eta1->Clone();
histResp[17] = (TH1F)JetResponseEt1000Eta1->Clone();
histResp[18] = (TH1F)JetResponseEt1400Eta1->Clone();
histResp[19] = (TH1F)JetResponseEt2000Eta1->Clone();
histResp[20] = (TH1F)JetResponseEt2900Eta1->Clone();
histResp[21] = (TH1F)JetResponseEt4500Eta1->Clone();

TH1F *histEt[n];
histEt[0] = (TH1F)EtGenJetEt10Eta1->Clone();
histEt[1] = (TH1F)EtGenJetEt12Eta1->Clone();
histEt[2] = (TH1F)EtGenJetEt15Eta1->Clone();
histEt[3] = (TH1F)EtGenJetEt20Eta1->Clone();
histEt[4] = (TH1F)EtGenJetEt27Eta1->Clone();
histEt[5] = (TH1F)EtGenJetEt35Eta1->Clone();
histEt[6] = (TH1F)EtGenJetEt45Eta1->Clone();
histEt[7] = (TH1F)EtGenJetEt57Eta1->Clone();
histEt[8] = (TH1F)EtGenJetEt72Eta1->Clone();
histEt[9] = (TH1F)EtGenJetEt90Eta1->Clone();
histEt[10] = (TH1F)EtGenJetEt120Eta1->Clone();
histEt[11] = (TH1F)EtGenJetEt150Eta1->Clone();
histEt[12] = (TH1F)EtGenJetEt200Eta1->Clone();
histEt[13] = (TH1F)EtGenJetEt300Eta1->Clone();
histEt[14] = (TH1F)EtGenJetEt400Eta1->Clone();
histEt[15] = (TH1F)EtGenJetEt550Eta1->Clone();
histEt[16] = (TH1F)EtGenJetEt750Eta1->Clone();
histEt[17] = (TH1F)EtGenJetEt1000Eta1->Clone();
histEt[18] = (TH1F)EtGenJetEt1400Eta1->Clone();
histEt[19] = (TH1F)EtGenJetEt2000Eta1->Clone();
histEt[20] = (TH1F)EtGenJetEt2900Eta1->Clone();
histEt[21] = (TH1F)EtGenJetEt4500Eta1->Clone();

char *name[n];
name[0] = "JetResponseEt10Eta1";
name[1] = "JetResponseEt12Eta1";
name[2] = "JetResponseEt15Eta1";
name[3] = "JetResponseEt20Eta1";
name[4] = "JetResponseEt27Eta1";
name[5] = "JetResponseEt35Eta1";
name[6] = "JetResponseEt45Eta1";
name[7] = "JetResponseEt57Eta1";
name[8] = "JetResponseEt72Eta1";
name[9] = "JetResponseEt90Eta1";
name[10] = "JetResponseEt120Eta1";
name[11] = "JetResponseEt150Eta1";
name[12] = "JetResponseEt200Eta1";
name[13] = "JetResponseEt300Eta1";
name[14] = "JetResponseEt400Eta1";
name[15] = "JetResponseEt550Eta1";
name[16] = "JetResponseEt750Eta1";
name[17] = "JetResponseEt1000Eta1";
name[18] = "JetResponseEt1400Eta1";
name[19] = "JetResponseEt2000Eta1";
name[20] = "JetResponseEt2900Eta1";
name[21] = "JetResponseEt4500Eta1";
...
ofstream outFile("CorrResponse_15.dat");
...
gr->SetTitle("MC Jets Calibration, Midpoint R=0.5, 4.000 < |#eta| < 4.400");
...
c1.Print("CorrResponse_15.eps");
c1.Print("CorrResponse_15.gif");
