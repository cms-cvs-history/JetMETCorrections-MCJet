...
ofstream outFile("CorrResponse_11.dat");
...
gr->SetTitle("MC Jets Calibration, Midpoint R=0.5, 2.487 < |#eta| < 2.690");
...
c1.Print("CorrResponse_11.eps");
c1.Print("CorrResponse_11.gif");
