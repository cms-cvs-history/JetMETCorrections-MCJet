...
TH1F *histResp[n];
histResp[0] = (TH1F)JetResponseEt10Eta4->Clone();
histResp[1] = (TH1F)JetResponseEt12Eta4->Clone();
histResp[2] = (TH1F)JetResponseEt15Eta4->Clone();
histResp[3] = (TH1F)JetResponseEt20Eta4->Clone();
histResp[4] = (TH1F)JetResponseEt27Eta4->Clone();
histResp[5] = (TH1F)JetResponseEt35Eta4->Clone();
histResp[6] = (TH1F)JetResponseEt45Eta4->Clone();
histResp[7] = (TH1F)JetResponseEt57Eta4->Clone();
histResp[8] = (TH1F)JetResponseEt72Eta4->Clone();
histResp[9] = (TH1F)JetResponseEt90Eta4->Clone();
histResp[10] = (TH1F)JetResponseEt120Eta4->Clone();
histResp[11] = (TH1F)JetResponseEt150Eta4->Clone();
histResp[12] = (TH1F)JetResponseEt200Eta4->Clone();
histResp[13] = (TH1F)JetResponseEt300Eta4->Clone();
histResp[14] = (TH1F)JetResponseEt400Eta4->Clone();
histResp[15] = (TH1F)JetResponseEt550Eta4->Clone();
histResp[16] = (TH1F)JetResponseEt750Eta4->Clone();
histResp[17] = (TH1F)JetResponseEt1000Eta4->Clone();
histResp[18] = (TH1F)JetResponseEt1400Eta4->Clone();
histResp[19] = (TH1F)JetResponseEt2000Eta4->Clone();
histResp[20] = (TH1F)JetResponseEt2900Eta4->Clone();
histResp[21] = (TH1F)JetResponseEt4500Eta4->Clone();

TH1F *histEt[n];
histEt[0] = (TH1F)EtGenJetEt10Eta4->Clone();
histEt[1] = (TH1F)EtGenJetEt12Eta4->Clone();
histEt[2] = (TH1F)EtGenJetEt15Eta4->Clone();
histEt[3] = (TH1F)EtGenJetEt20Eta4->Clone();
histEt[4] = (TH1F)EtGenJetEt27Eta4->Clone();
histEt[5] = (TH1F)EtGenJetEt35Eta4->Clone();
histEt[6] = (TH1F)EtGenJetEt45Eta4->Clone();
histEt[7] = (TH1F)EtGenJetEt57Eta4->Clone();
histEt[8] = (TH1F)EtGenJetEt72Eta4->Clone();
histEt[9] = (TH1F)EtGenJetEt90Eta4->Clone();
histEt[10] = (TH1F)EtGenJetEt120Eta4->Clone();
histEt[11] = (TH1F)EtGenJetEt150Eta4->Clone();
histEt[12] = (TH1F)EtGenJetEt200Eta4->Clone();
histEt[13] = (TH1F)EtGenJetEt300Eta4->Clone();
histEt[14] = (TH1F)EtGenJetEt400Eta4->Clone();
histEt[15] = (TH1F)EtGenJetEt550Eta4->Clone();
histEt[16] = (TH1F)EtGenJetEt750Eta4->Clone();
histEt[17] = (TH1F)EtGenJetEt1000Eta4->Clone();
histEt[18] = (TH1F)EtGenJetEt1400Eta4->Clone();
histEt[19] = (TH1F)EtGenJetEt2000Eta4->Clone();
histEt[20] = (TH1F)EtGenJetEt2900Eta4->Clone();
histEt[21] = (TH1F)EtGenJetEt4500Eta4->Clone();

char *name[n];
name[0] = "JetResponseEt10Eta4";
name[1] = "JetResponseEt12Eta4";
name[2] = "JetResponseEt15Eta4";
name[3] = "JetResponseEt20Eta4";
name[4] = "JetResponseEt27Eta4";
name[5] = "JetResponseEt35Eta4";
name[6] = "JetResponseEt45Eta4";
name[7] = "JetResponseEt57Eta4";
name[8] = "JetResponseEt72Eta4";
name[9] = "JetResponseEt90Eta4";
name[10] = "JetResponseEt120Eta4";
name[11] = "JetResponseEt150Eta4";
name[12] = "JetResponseEt200Eta4";
name[13] = "JetResponseEt300Eta4";
name[14] = "JetResponseEt400Eta4";
name[15] = "JetResponseEt550Eta4";
name[16] = "JetResponseEt750Eta4";
name[17] = "JetResponseEt1000Eta4";
name[18] = "JetResponseEt1400Eta4";
name[19] = "JetResponseEt2000Eta4";
name[20] = "JetResponseEt2900Eta4";
name[21] = "JetResponseEt4500Eta4";
...
ofstream outFile("CorrResponse_12.dat");
...
gr->SetTitle("MC Jets Calibration, Midpoint R=0.5, 2.690 < |#eta| < 2.916");
...
c1.Print("CorrResponse_12.eps");
c1.Print("CorrResponse_12.gif");
