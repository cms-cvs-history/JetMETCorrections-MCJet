...
TH1F *histResp[n];
histResp[0] = (TH1F)JetResponseEt10Eta11->Clone();
histResp[1] = (TH1F)JetResponseEt12Eta11->Clone();
histResp[2] = (TH1F)JetResponseEt15Eta11->Clone();
histResp[3] = (TH1F)JetResponseEt20Eta11->Clone();
histResp[4] = (TH1F)JetResponseEt27Eta11->Clone();
histResp[5] = (TH1F)JetResponseEt35Eta11->Clone();
histResp[6] = (TH1F)JetResponseEt45Eta11->Clone();
histResp[7] = (TH1F)JetResponseEt57Eta11->Clone();
histResp[8] = (TH1F)JetResponseEt72Eta11->Clone();
histResp[9] = (TH1F)JetResponseEt90Eta11->Clone();
histResp[10] = (TH1F)JetResponseEt120Eta11->Clone();
histResp[11] = (TH1F)JetResponseEt150Eta11->Clone();
histResp[12] = (TH1F)JetResponseEt200Eta11->Clone();
histResp[13] = (TH1F)JetResponseEt300Eta11->Clone();
histResp[14] = (TH1F)JetResponseEt400Eta11->Clone();
histResp[15] = (TH1F)JetResponseEt550Eta11->Clone();
histResp[16] = (TH1F)JetResponseEt750Eta11->Clone();
histResp[17] = (TH1F)JetResponseEt1000Eta11->Clone();
histResp[18] = (TH1F)JetResponseEt1400Eta11->Clone();
histResp[19] = (TH1F)JetResponseEt2000Eta11->Clone();
histResp[20] = (TH1F)JetResponseEt2900Eta11->Clone();
histResp[21] = (TH1F)JetResponseEt4500Eta11->Clone();

// Clone the Et histograms into a histogram array
TH1F *histEt[n];
histEt[0] = (TH1F)EtGenJetEt10Eta11->Clone();
histEt[1] = (TH1F)EtGenJetEt12Eta11->Clone();
histEt[2] = (TH1F)EtGenJetEt15Eta11->Clone();
histEt[3] = (TH1F)EtGenJetEt20Eta11->Clone();
histEt[4] = (TH1F)EtGenJetEt27Eta11->Clone();
histEt[5] = (TH1F)EtGenJetEt35Eta11->Clone();
histEt[6] = (TH1F)EtGenJetEt45Eta11->Clone();
histEt[7] = (TH1F)EtGenJetEt57Eta11->Clone();
histEt[8] = (TH1F)EtGenJetEt72Eta11->Clone();
histEt[9] = (TH1F)EtGenJetEt90Eta11->Clone();
histEt[10] = (TH1F)EtGenJetEt120Eta11->Clone();
histEt[11] = (TH1F)EtGenJetEt150Eta11->Clone();
histEt[12] = (TH1F)EtGenJetEt200Eta11->Clone();
histEt[13] = (TH1F)EtGenJetEt300Eta11->Clone();
histEt[14] = (TH1F)EtGenJetEt400Eta11->Clone();
histEt[15] = (TH1F)EtGenJetEt550Eta11->Clone();
histEt[16] = (TH1F)EtGenJetEt750Eta11->Clone();
histEt[17] = (TH1F)EtGenJetEt1000Eta11->Clone();
histEt[18] = (TH1F)EtGenJetEt1400Eta11->Clone();
histEt[19] = (TH1F)EtGenJetEt2000Eta11->Clone();
histEt[20] = (TH1F)EtGenJetEt2900Eta11->Clone();
histEt[21] = (TH1F)EtGenJetEt4500Eta11->Clone();

// Histogram names needed for output filenemas
char *name[n];
name[0] = "JetResponseEt10Eta11";
name[1] = "JetResponseEt12Eta11";
name[2] = "JetResponseEt15Eta11";
name[3] = "JetResponseEt20Eta11";
name[4] = "JetResponseEt27Eta11";
name[5] = "JetResponseEt35Eta11";
name[6] = "JetResponseEt45Eta11";
name[7] = "JetResponseEt57Eta11";
name[8] = "JetResponseEt72Eta11";
name[9] = "JetResponseEt90Eta11";
name[10] = "JetResponseEt120Eta11";
name[11] = "JetResponseEt150Eta11";
name[12] = "JetResponseEt200Eta11";
name[13] = "JetResponseEt300Eta11";
name[14] = "JetResponseEt400Eta11";
name[15] = "JetResponseEt550Eta11";
name[16] = "JetResponseEt750Eta11";
name[17] = "JetResponseEt1000Eta11";
name[18] = "JetResponseEt1400Eta11";
name[19] = "JetResponseEt2000Eta11";
name[20] = "JetResponseEt2900Eta11";
name[21] = "JetResponseEt4500Eta11";
...
gr2->SetTitle("MC Jets Calibration, Midpoint R=0.5, 0.991 < | #eta | < 1.260");
