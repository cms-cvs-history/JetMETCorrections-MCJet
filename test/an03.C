...
TH1F *histResp[n];
histResp[0] = (TH1F)JetResponseEt10Eta13->Clone();
histResp[1] = (TH1F)JetResponseEt12Eta13->Clone();
histResp[2] = (TH1F)JetResponseEt15Eta13->Clone();
histResp[3] = (TH1F)JetResponseEt20Eta13->Clone();
histResp[4] = (TH1F)JetResponseEt27Eta13->Clone();
histResp[5] = (TH1F)JetResponseEt35Eta13->Clone();
histResp[6] = (TH1F)JetResponseEt45Eta13->Clone();
histResp[7] = (TH1F)JetResponseEt57Eta13->Clone();
histResp[8] = (TH1F)JetResponseEt72Eta13->Clone();
histResp[9] = (TH1F)JetResponseEt90Eta13->Clone();
histResp[10] = (TH1F)JetResponseEt120Eta13->Clone();
histResp[11] = (TH1F)JetResponseEt150Eta13->Clone();
histResp[12] = (TH1F)JetResponseEt200Eta13->Clone();
histResp[13] = (TH1F)JetResponseEt300Eta13->Clone();
histResp[14] = (TH1F)JetResponseEt400Eta13->Clone();
histResp[15] = (TH1F)JetResponseEt550Eta13->Clone();
histResp[16] = (TH1F)JetResponseEt750Eta13->Clone();
histResp[17] = (TH1F)JetResponseEt1000Eta13->Clone();
histResp[18] = (TH1F)JetResponseEt1400Eta13->Clone();
histResp[19] = (TH1F)JetResponseEt2000Eta13->Clone();
histResp[20] = (TH1F)JetResponseEt2900Eta13->Clone();
histResp[21] = (TH1F)JetResponseEt4500Eta13->Clone();

// Clone the Et histograms into a histogram array
TH1F *histEt[n];
histEt[0] = (TH1F)EtGenJetEt10Eta13->Clone();
histEt[1] = (TH1F)EtGenJetEt12Eta13->Clone();
histEt[2] = (TH1F)EtGenJetEt15Eta13->Clone();
histEt[3] = (TH1F)EtGenJetEt20Eta13->Clone();
histEt[4] = (TH1F)EtGenJetEt27Eta13->Clone();
histEt[5] = (TH1F)EtGenJetEt35Eta13->Clone();
histEt[6] = (TH1F)EtGenJetEt45Eta13->Clone();
histEt[7] = (TH1F)EtGenJetEt57Eta13->Clone();
histEt[8] = (TH1F)EtGenJetEt72Eta13->Clone();
histEt[9] = (TH1F)EtGenJetEt90Eta13->Clone();
histEt[10] = (TH1F)EtGenJetEt120Eta13->Clone();
histEt[11] = (TH1F)EtGenJetEt150Eta13->Clone();
histEt[12] = (TH1F)EtGenJetEt200Eta13->Clone();
histEt[13] = (TH1F)EtGenJetEt300Eta13->Clone();
histEt[14] = (TH1F)EtGenJetEt400Eta13->Clone();
histEt[15] = (TH1F)EtGenJetEt550Eta13->Clone();
histEt[16] = (TH1F)EtGenJetEt750Eta13->Clone();
histEt[17] = (TH1F)EtGenJetEt1000Eta13->Clone();
histEt[18] = (TH1F)EtGenJetEt1400Eta13->Clone();
histEt[19] = (TH1F)EtGenJetEt2000Eta13->Clone();
histEt[20] = (TH1F)EtGenJetEt2900Eta13->Clone();
histEt[21] = (TH1F)EtGenJetEt4500Eta13->Clone();

// Histogram names needed for output filenemas
char *name[n];
name[0] = "JetResponseEt10Eta13";
name[1] = "JetResponseEt12Eta13";
name[2] = "JetResponseEt15Eta13";
name[3] = "JetResponseEt20Eta13";
name[4] = "JetResponseEt27Eta13";
name[5] = "JetResponseEt35Eta13";
name[6] = "JetResponseEt45Eta13";
name[7] = "JetResponseEt57Eta13";
name[8] = "JetResponseEt72Eta13";
name[9] = "JetResponseEt90Eta13";
name[10] = "JetResponseEt120Eta13";
name[11] = "JetResponseEt150Eta13";
name[12] = "JetResponseEt200Eta13";
name[13] = "JetResponseEt300Eta13";
name[14] = "JetResponseEt400Eta13";
name[15] = "JetResponseEt550Eta13";
name[16] = "JetResponseEt750Eta13";
name[17] = "JetResponseEt1000Eta13";
name[18] = "JetResponseEt1400Eta13";
name[19] = "JetResponseEt2000Eta13";
name[20] = "JetResponseEt2900Eta13";
name[21] = "JetResponseEt4500Eta13";
...
gr2->SetTitle("MC Jets Calibration, Midpoint R=0.5, 0.441 < | #eta | < 0.751");
