...
TF1 *fit[n];
JetResponseEt10Eta12->Fit("gaus","","",.162,.425);
c1.Print("tmp/JetResponseEt10Eta12.gif");
fit[0] = JetResponseEt10Eta12->GetFunction("gaus");

JetResponseEt12Eta12->Fit("gaus","","",0.16,0.427);
c1.Print("tmp/JetResponseEt12Eta12.gif");
fit[1] = JetResponseEt12Eta12->GetFunction("gaus");

JetResponseEt15Eta12->Fit("gaus","","",0.165,0.44);
c1.Print("tmp/JetResponseEt15Eta12.gif");
fit[2] = JetResponseEt15Eta12->GetFunction("gaus");

JetResponseEt20Eta12->Fit("gaus","","",0.186,0.49);
c1.Print("tmp/JetResponseEt20Eta12.gif");
fit[3] = JetResponseEt20Eta12->GetFunction("gaus");

JetResponseEt27Eta12->Fit("gaus","","",0.25,0.525);
c1.Print("tmp/JetResponseEt27Eta12.gif");
fit[4] = JetResponseEt27Eta12->GetFunction("gaus");

JetResponseEt35Eta12->Fit("gaus","","",0.298,0.57);
c1.Print("tmp/JetResponseEt35Eta12.gif");
fit[5] = JetResponseEt35Eta12->GetFunction("gaus");

JetResponseEt45Eta12->Fit("gaus","","",0.357,0.608);
c1.Print("tmp/JetResponseEt45Eta12.gif");
fit[6] = JetResponseEt45Eta12->GetFunction("gaus");

JetResponseEt57Eta12->Fit("gaus","","",0.404,0.642);
c1.Print("tmp/JetResponseEt57Eta12.gif");
fit[7] = JetResponseEt57Eta12->GetFunction("gaus");

JetResponseEt72Eta12->Fit("gaus","","",0.442,0.685);
c1.Print("tmp/JetResponseEt72Eta12.gif");
fit[8] = JetResponseEt72Eta12->GetFunction("gaus");

JetResponseEt90Eta12->Fit("gaus","","",0.494,0.721);
c1.Print("tmp/JetResponseEt90Eta12.gif");
fit[9] = JetResponseEt90Eta12->GetFunction("gaus");

JetResponseEt120Eta12->Fit("gaus","","",0.55,0.752);
c1.Print("tmp/JetResponseEt120Eta12.gif");
fit[10] = JetResponseEt120Eta12->GetFunction("gaus");

JetResponseEt150Eta12->Fit("gaus","","",0.595,0.78);
c1.Print("tmp/JetResponseEt150Eta12.gif");
fit[11] = JetResponseEt150Eta12->GetFunction("gaus");

JetResponseEt200Eta12->Fit("gaus","","",0.652,0.81);
c1.Print("tmp/JetResponseEt200Eta12.gif");
fit[12] = JetResponseEt200Eta12->GetFunction("gaus");

JetResponseEt300Eta12->Fit("gaus","","",0.7,0.832);
c1.Print("tmp/JetResponseEt300Eta12.gif");
fit[13] = JetResponseEt300Eta12->GetFunction("gaus");

JetResponseEt400Eta12->Fit("gaus","","",0.731,0.852);
c1.Print("tmp/JetResponseEt400Eta12.gif");
fit[14] = JetResponseEt400Eta12->GetFunction("gaus");

JetResponseEt550Eta12->Fit("gaus","","",0.758,0.874);
c1.Print("tmp/JetResponseEt550Eta12.gif");
fit[15] = JetResponseEt550Eta12->GetFunction("gaus");

JetResponseEt750Eta12->Fit("gaus","","",0.785,0.89);
c1.Print("tmp/JetResponseEt750Eta12.gif");
fit[16] = JetResponseEt750Eta12->GetFunction("gaus");

JetResponseEt1000Eta12->Fit("gaus","","",0.805,0.9);
c1.Print("tmp/JetResponseEt1000Eta12.gif");
fit[17] = JetResponseEt1000Eta12->GetFunction("gaus");

JetResponseEt1400Eta12->Fit("gaus","","",.828,.916);
c1.Print("tmp/JetResponseEt1400Eta12.gif");
fit[18] = JetResponseEt1400Eta12->GetFunction("gaus");

JetResponseEt2000Eta12->Fit("gaus","","",.845,.925);
c1.Print("tmp/JetResponseEt2000Eta12.gif");
fit[19] = JetResponseEt2000Eta12->GetFunction("gaus");

JetResponseEt2900Eta12->Fit("gaus","","",.85,.927);
c1.Print("tmp/JetResponseEt2900Eta12.gif");
...
c2hA.Print("Et_mc04.eps");
c2hA.Print("Et_mc04.gif");
...
e4, por1, por2, par[0], par[1], par[2], par[3], par[4], par[5], par[6]);

fclose(Out1);

//JetResponseEt4500Eta19->Draw();
