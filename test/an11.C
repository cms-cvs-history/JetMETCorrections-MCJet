...
TH1F *histResp[n];
histResp[0] = (TH1F)JetResponseEt10Eta5->Clone();
histResp[1] = (TH1F)JetResponseEt12Eta5->Clone();
histResp[2] = (TH1F)JetResponseEt15Eta5->Clone();
histResp[3] = (TH1F)JetResponseEt20Eta5->Clone();
histResp[4] = (TH1F)JetResponseEt27Eta5->Clone();
histResp[5] = (TH1F)JetResponseEt35Eta5->Clone();
histResp[6] = (TH1F)JetResponseEt45Eta5->Clone();
histResp[7] = (TH1F)JetResponseEt57Eta5->Clone();
histResp[8] = (TH1F)JetResponseEt72Eta5->Clone();
histResp[9] = (TH1F)JetResponseEt90Eta5->Clone();
histResp[10] = (TH1F)JetResponseEt120Eta5->Clone();
histResp[11] = (TH1F)JetResponseEt150Eta5->Clone();
histResp[12] = (TH1F)JetResponseEt200Eta5->Clone();
histResp[13] = (TH1F)JetResponseEt300Eta5->Clone();
histResp[14] = (TH1F)JetResponseEt400Eta5->Clone();
histResp[15] = (TH1F)JetResponseEt550Eta5->Clone();
histResp[16] = (TH1F)JetResponseEt750Eta5->Clone();
histResp[17] = (TH1F)JetResponseEt1000Eta5->Clone();
histResp[18] = (TH1F)JetResponseEt1400Eta5->Clone();
histResp[19] = (TH1F)JetResponseEt2000Eta5->Clone();
histResp[20] = (TH1F)JetResponseEt2900Eta5->Clone();
histResp[21] = (TH1F)JetResponseEt4500Eta5->Clone();

// Clone the Et histograms into a histogram array
TH1F *histEt[n];
histEt[0] = (TH1F)EtGenJetEt10Eta5->Clone();
histEt[1] = (TH1F)EtGenJetEt12Eta5->Clone();
histEt[2] = (TH1F)EtGenJetEt15Eta5->Clone();
histEt[3] = (TH1F)EtGenJetEt20Eta5->Clone();
histEt[4] = (TH1F)EtGenJetEt27Eta5->Clone();
histEt[5] = (TH1F)EtGenJetEt35Eta5->Clone();
histEt[6] = (TH1F)EtGenJetEt45Eta5->Clone();
histEt[7] = (TH1F)EtGenJetEt57Eta5->Clone();
histEt[8] = (TH1F)EtGenJetEt72Eta5->Clone();
histEt[9] = (TH1F)EtGenJetEt90Eta5->Clone();
histEt[10] = (TH1F)EtGenJetEt120Eta5->Clone();
histEt[11] = (TH1F)EtGenJetEt150Eta5->Clone();
histEt[12] = (TH1F)EtGenJetEt200Eta5->Clone();
histEt[13] = (TH1F)EtGenJetEt300Eta5->Clone();
histEt[14] = (TH1F)EtGenJetEt400Eta5->Clone();
histEt[15] = (TH1F)EtGenJetEt550Eta5->Clone();
histEt[16] = (TH1F)EtGenJetEt750Eta5->Clone();
histEt[17] = (TH1F)EtGenJetEt1000Eta5->Clone();
histEt[18] = (TH1F)EtGenJetEt1400Eta5->Clone();
histEt[19] = (TH1F)EtGenJetEt2000Eta5->Clone();
histEt[20] = (TH1F)EtGenJetEt2900Eta5->Clone();
histEt[21] = (TH1F)EtGenJetEt4500Eta5->Clone();

// Histogram names needed for output filenemas
char *name[n];
name[0] = "JetResponseEt10Eta5";
name[1] = "JetResponseEt12Eta5";
name[2] = "JetResponseEt15Eta5";
name[3] = "JetResponseEt20Eta5";
name[4] = "JetResponseEt27Eta5";
name[5] = "JetResponseEt35Eta5";
name[6] = "JetResponseEt45Eta5";
name[7] = "JetResponseEt57Eta5";
name[8] = "JetResponseEt72Eta5";
name[9] = "JetResponseEt90Eta5";
name[10] = "JetResponseEt120Eta5";
name[11] = "JetResponseEt150Eta5";
name[12] = "JetResponseEt200Eta5";
name[13] = "JetResponseEt300Eta5";
name[14] = "JetResponseEt400Eta5";
name[15] = "JetResponseEt550Eta5";
name[16] = "JetResponseEt750Eta5";
name[17] = "JetResponseEt1000Eta5";
name[18] = "JetResponseEt1400Eta5";
name[19] = "JetResponseEt2000Eta5";
name[20] = "JetResponseEt2900Eta5";
name[21] = "JetResponseEt4500Eta5";
...
ofstream outFile("Response_11.dat");
...
gr2->SetTitle("MC Jets Calibration, Midpoint R=0.5, 2.487 < | #eta | < 2.690");
