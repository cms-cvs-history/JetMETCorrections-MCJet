...
ofstream outFile("CorrResponse_03_1sigma.dat");
for (Int_t i=0; i<n; i++){
...
c2hA.Print("CorrResponse_03_1sigma.eps");
c2hA.Print("CorrResponse_03_1sigma.gif");
